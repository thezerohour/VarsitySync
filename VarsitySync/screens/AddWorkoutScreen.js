import { View, Text, TouchableOpacity, TextInput, TouchableWithoutFeedback, Keyboard, StyleSheet, Image } from 'react-native'
  ...
  return (
    <View className= "flex-1 bg-white">
        <SafeAreaView className= "flex">
            ...
            <Image source={require("../assets/images/training.png")}
                    style= {{width: 350, height: 300}} />
            </View>
        </SafeAreaView>
        
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View className= "flex-1 bg-slate-900 px-8 pt-2 mt-5"
            style= {{borderTopLeftRadius: 50, borderTopRightRadius: 50}}>
     
            <View className= "space-y-2">
                <Text className="text-white ml-4 mt-2 text-xl font-extrabold">
                    Exercise
                </Text>
            </View>
            ...
            <View className= "space-y-2 mt-[-40px]">
                <Text className="text-white ml-4 mt-10 text-xl font-extrabold">Description</Text>
            </View>
            ...
            <TouchableOpacity 
                ...
                <Text className="text-center text-white font-extrabold text-2xl">
                    Submit
                </Text>
            </TouchableOpacity>
