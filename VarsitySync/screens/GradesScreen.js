    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View
                    className="p-2 bg-gray-100 text-white rounded-2xl mb-3 mt-2 flex-row"
            ...
            <View
                style={{ marginTop: 160, marginLeft: 35, marginBottom: -100 }}
            >
                <Text className="text-white ml-4 mt-2 text-2xl font-bold">
                    Grades
                </Text>
            ...
            <View
                className="p-3 bg-gray-100 text-white rounded-2xl mb-3 mt-28 mx-8 flex-1"
